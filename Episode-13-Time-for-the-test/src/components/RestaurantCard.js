...
const RestaurantCard = (props) => {
    ...
    return(
        <div data-testid="resCard" className="relative w-[200px] rounded mb-7 hover:scale-[0.95] transition duration-[0.15s] hover:ease-in">
...
export const offerLabel = (RestaurantCard) => {
    return (props) => {
        ...
        return (
            <div>
                <label data-testid="label" className="absolute z-20 bg-[#003049] text-xs text-[#eae2b7] px-3 py-1 rounded-br-md rounded-tl-md">FLAT DEAL</label>
