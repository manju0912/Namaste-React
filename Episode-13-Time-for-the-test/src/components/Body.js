    ...
    : (
        <div className="px-[90px]">
            <div className="flex justify-between my-6 pt-4">
                <div>
                    <input data-testid="searchInput" type="text" id="search" name="search" value={searchText} onChange={(e) => {setSearchText(e.target.value);}} placeholder="Search for cuisines, restaurants..." className="shadow
